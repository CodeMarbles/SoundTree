 ...
 *
 * Intended to be called once at startup from [com.treecast.app.ui.SplashActivity]
 * so that [com.treecast.app.ui.MainActivity] can show a recovery prompt if
...
object OrphanRecordingScanner {
     ...
     *
     * Mirrors the selection logic in [com.treecast.app.service.RecordingService.createOutputFile]:
