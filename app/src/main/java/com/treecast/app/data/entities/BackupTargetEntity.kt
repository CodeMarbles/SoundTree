...
data class BackupTargetEntity(
     ...
     * Matches the format used by [com.treecast.app.util.AppVolume.uuid]:
     *   - [com.treecast.app.util.StorageVolumeHelper.UUID_PRIMARY] ("primary")
     ...
     *
     * Updated by [com.treecast.app.worker.BackupWorker] on successful
