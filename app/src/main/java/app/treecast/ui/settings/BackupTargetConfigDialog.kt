...
import app.treecast.ui.clearBackupLogsForVolume
import app.treecast.ui.getBackupLogsForVolume
import app.treecast.ui.removeBackupTarget
...
class BackupTargetConfigDialog : BottomSheetDialogFragment() {
     ...
     * live (the worker calls [app.treecast.data.dao.BackupLogDao.updateStats]
