 ...
 * [app.treecast.data.entities.BackupTargetEntity.onConnectEnabled] = true.
 *
            ...
            try {
                ...
                if (target != null && target.onConnectEnabled) {
                    BackupWorker.enqueueOneTime(
                        ...
                        trigger    = app.treecast.data.entities.BackupLogEntity.BackupTrigger.ON_CONNECT,
                    )
                }
            } finally {
