package app.treecast.export

/**
 * Root model for a TreeCast recording export JSON file (schema version 1).
 *
 ...
 * @property generator      Constant identifying the producing app ("treecast").
...
data class RecordingExportMetadata(
    ...
    companion object {
        ...
        const val GENERATOR      = "treecast"
    }
}

/**
 * Core metadata fields drawn from [app.treecast.data.entities.RecordingEntity].
 *
