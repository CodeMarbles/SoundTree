 ...
 *
 * Intended to be called once at startup from [app.treecast.ui.SplashActivity]
 * so that [app.treecast.ui.MainActivity] can show a recovery prompt if
...
object OrphanRecordingScanner {
     ...
     *
     * Mirrors the selection logic in [app.treecast.service.RecordingService.createOutputFile]:
