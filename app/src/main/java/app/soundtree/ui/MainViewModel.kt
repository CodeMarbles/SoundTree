...
class MainViewModel(app: Application) : AndroidViewModel(app) {
    ...
    internal val prefs: SharedPreferences =
        app.getSharedPreferences("soundtree_settings", Context.MODE_PRIVATE)
        ...
        controllerFuture.addListener(
            {
                try {
                    mediaController = controllerFuture.get().also { controller ->
                        ...
                        startObservingTopicsForNotification()
                    }
                } catch (e: Exception) {
     ...
     *
     * Called by [app.soundtree.ui.recovery.OrphanRecoveryDialogFragment]
