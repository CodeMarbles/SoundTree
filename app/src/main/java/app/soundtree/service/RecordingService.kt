...
//        Log.w("TC_DEBUG", "RecordingService.onDestroy() called — state was ${_state.value}")
    ...
    private fun saveFromNotification() {
        ...
        val repo         = (applicationContext as app.soundtree.SoundTreeApp).repository
    ...
    companion object {
        ...
        // Intent actions
        const val ACTION_START     = "app.soundtree.START"
        const val ACTION_PAUSE     = "app.soundtree.PAUSE"
        const val ACTION_RESUME    = "app.soundtree.RESUME"
        const val ACTION_STOP      = "app.soundtree.STOP"
        const val ACTION_SAVE      = "app.soundtree.SAVE"
        const val ACTION_SET_TOPIC = "app.soundtree.SET_TOPIC"
        const val ACTION_DROP_MARK = "app.soundtree.DROP_MARK"

        private const val SCO_TIMEOUT_MS = 3_000L

        // Intent extras
        const val EXTRA_TOPIC_ID = "app.soundtree.extra.TOPIC_ID"
