...
import app.soundtree.data.entities.BackupLogEntity.BackupStatus
import app.soundtree.data.entities.BackupLogEntity.BackupTrigger
import app.soundtree.data.entities.BackupLogEventEntity
import app.soundtree.data.entities.BackupLogEventEntity.EventType
...
class BackupWorker(context: Context, params: WorkerParameters) :
     ...
     * snapshot (e.g. `soundtree_20250412_143022.db`) into `db/` on the backup
