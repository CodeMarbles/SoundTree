...
data class BackupTargetEntity(
     ...
     * Matches the format used by [app.soundtree.util.AppVolume.uuid]:
     *   - [app.soundtree.util.StorageVolumeHelper.UUID_PRIMARY] ("primary")
     ...
     *
     * Updated by [app.soundtree.worker.BackupWorker] on successful
