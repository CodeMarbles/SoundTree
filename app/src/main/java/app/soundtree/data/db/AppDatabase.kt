...
import app.soundtree.data.dao.BackupLogDao
import app.soundtree.data.dao.BackupTargetDao
import app.soundtree.data.dao.MarkDao
import app.soundtree.data.dao.RecordingDao
import app.soundtree.data.dao.TopicDao
...
abstract class AppDatabase : RoomDatabase() {
    ...
    companion object {
         ...
         *
         * Called by [app.soundtree.util.DatabaseRestoreManager] before swapping
